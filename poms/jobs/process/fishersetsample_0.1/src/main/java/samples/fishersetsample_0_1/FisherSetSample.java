...
package samples.fishersetsample_0_1;
...
/**
 * Job: FisherSetSample Purpose: Sample of prediction on Fisher's set data<br>
 * Description: Sample of prediction on Fisher's set data <br>
 * @author 
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class FisherSetSample implements TalendJob {
	...
	private final String jobName = "FisherSetSample";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					FisherSetSample.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(FisherSetSample.this, new Object[] { e,
	...
	public static class row15Struct implements
		...
		final static byte[] commonByteArrayLock_SAMPLES_FisherSetSample = new byte[0];
		static byte[] commonByteArray_SAMPLES_FisherSetSample = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SAMPLES_FisherSetSample.length) {
					if (length < 1024
							&& commonByteArray_SAMPLES_FisherSetSample.length == 0) {
						commonByteArray_SAMPLES_FisherSetSample = new byte[1024];
					} else {
						commonByteArray_SAMPLES_FisherSetSample = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SAMPLES_FisherSetSample, 0,
						length);
				strReturn = new String(commonByteArray_SAMPLES_FisherSetSample,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SAMPLES_FisherSetSample) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "/home/romuald/Projects/Talend/TOS_BD/workspace/SAMPLES/data/fisher's data.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"/home/romuald/Projects/Talend/TOS_BD/workspace/SAMPLES/data/fisher's data.csv",
								"ISO-8859-15", ",", "\n", true, 1, 0, -1, -1,
								false);
					...
					if (!((Object) ("/home/romuald/Projects/Talend/TOS_BD/workspace/SAMPLES/data/fisher's data.csv") instanceof java.io.InputStream)) {
				...
				for (com.github.romualdrousseau.shuju.DataRow row : dataset_tShujuTransform_2_TransformIn
						.rows()) {
					row5.sepalLength = (Double) row.features().get(0)
							.getValue();
					row5.sepalWidth = (Double) row.features().get(1).getValue();
					row5.petalLength = (Double) row.features().get(2)
							.getValue();
					row5.petalWidth = (Double) row.features().get(3).getValue();
					row5.species = (String) row.getLabel().getValue();
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int n = 0; n < globalBuffer.size(); n++) {
					...
					row8.RESULT_LABEL = result.getLabel().getValue().toString();
	...
	public static void main(String[] args) {
		final FisherSetSample FisherSetSampleClass = new FisherSetSample();

		int exitCode = FisherSetSampleClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = FisherSetSample.class
					.getClassLoader().getResourceAsStream(
							"samples/fishersetsample_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = FisherSetSample.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : FisherSetSample");
		}
...
/************************************************************************************************
 * 212383 characters generated by Talend Open Studio for Big Data on the
 * September 16, 2018 10:13:03 PM CST
 ************************************************************************************************/
